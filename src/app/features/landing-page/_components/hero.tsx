    ...
    <section className="min-h-screen sticky top-0 grid place-items-center">
      <div className="h-full w-full relative flex items-end justify-center">
        ...
        <div className="absolute top-8 left-2/4 -translate-x-2/4 w-full">
          <div className="flex items-center justify-end w-full max-w-7xl mx-auto relative px-4">
            ...
            <div className="flex items-center gap-2 absolute top-2/4 -translate-y-2/4 right-4">

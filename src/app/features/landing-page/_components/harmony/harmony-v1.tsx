...
export default function HarmonyV1({}: Props) {
  useLayoutEffect(() => {
  ...
  return (
    ...
    >
      <h2 className="harmony-text text-4xl max-w-[19ch] text-center mx-auto translate-y-5 will-change-[clip-path,transform,opacity] mb-5 opacity-100">
        {hamronyTitle}
      </h2>
      <Image
